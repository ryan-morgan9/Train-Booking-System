...
Group Implementation is not functional. it's just to show
how we designed it and how it would be implemented.

Website and code is in 'TrainWebsite' Folder. 'ryan_Booking.txt' is a receipt that
was generated for the user with the name 'ryan'.
